...
module.exports =
    ...
    generateLayerGCode: (slicer, paths, z, layerIndex, centerOffsetX = 0, centerOffsetY = 0, totalLayers = 0, allLayers = [], layerSegments = []) ->
        ...
        generateWallsForPath = (path, pathIndex, isHole, generateSkinWalls = false) =>
            ...
            # Note: For structures, skin walls are generated in Phase 2 along with skin infill.
            # Generating them here would cause duplication.
        ...
        for path, pathIndex in paths
            ...
            if needsSkin
                ...
                # Use hole skin walls for exclusion zones.
                # Structure skin walls are generated by generateSkinGCode itself.
