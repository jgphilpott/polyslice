...
class Polyslice
    ...
    constructor: (options = {}) ->
        ...
        @metadataTitle = options.metadataTitle ?= true # Boolean - include "Generated by Polyslice" title.
    ...
    getMetadataTitle: ->
        accessors.getMetadataTitle(this)
    ...
    setMetadataTitle: (enabled = true) ->
        accessors.setMetadataTitle(this, enabled)
