/**
 * Example: slice the LEGO brick test model from an STL and write G-code to examples/output.
 *
 * Usage:
 *   node examples/scripts/slice-lego.js
 */
...
async function main() {
  console.log("Polyslice LEGO Brick Example");
  console.log("============================\n");

  const stlPath = path.join(__dirname, "../../resources/testing/lego/brick.test.stl");
