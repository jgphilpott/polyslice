...
describe('Polyslice', () => {
  ...
  describe('G-code Generation', () => {
    test('should generate autohome G-code', () => {
      ...
      const xcodeHome = slicer.codeAutohome(true, false, false);
